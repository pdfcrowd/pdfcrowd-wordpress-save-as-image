    ...
    <table class="form-table">
        <tbody>
            <tr>
                ...
                <td>
                    <input type="checkbox" id="save-as-image-pdfcrowd-dev-mode" name="save-as-image-pdfcrowd[dev_mode]" value="1" <?php checked( $dev_mode, 1 ); ?> />
            ...
            <tr>
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="save-as-image-pdfcrowd-image-text">
                            <input type="radio" id="save-as-image-pdfcrowd-image-text" name="save-as-image-pdfcrowd[button_format]" value="image-text" <?php checked( $button_format, "image-text" ); ?> />
                            image-text
                        </label><br>
                        <label for="save-as-image-pdfcrowd-text-image">
                            <input type="radio" id="save-as-image-pdfcrowd-text-image" name="save-as-image-pdfcrowd[button_format]" value="text-image" <?php checked( $button_format, "text-image" ); ?> />
                            text-image
                        </label><br>
                        <label for="save-as-image-pdfcrowd-image">
                            <input type="radio" id="save-as-image-pdfcrowd-image" name="save-as-image-pdfcrowd[button_format]" value="image" <?php checked( $button_format, "image" ); ?> />
                            image
                        </label><br>
                        <label for="save-as-image-pdfcrowd-text">
                            <input type="radio" id="save-as-image-pdfcrowd-text" name="save-as-image-pdfcrowd[button_format]" value="text" <?php checked( $button_format, "text" ); ?> />
                            text
                        </label><br>
                    </fieldset>
                </td>
