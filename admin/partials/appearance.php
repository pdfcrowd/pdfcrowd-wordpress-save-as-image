                ...
                <td id='save-as-image-pdfcrowd-images'>
                    <fieldset>
                        ...
                        <label for="save-as-image-pdfcrowd-custom-image-h">
                            ...
                            Custom HTML
                            <br/>
                            <textarea class="clear regular-text" id="save-as-image-pdfcrowd-custom-html" name="save-as-image-pdfcrowd[button_custom_html]" rows=5 cols=60 style='margin-left: 2em'><?php echo($button_custom_html); ?></textarea>
                            <p class='save-as-image-pdfcrowd-devi'>
