                ...
                <td>
                  <input
                    ...
                    <div class="save-as-image-pdfcrowd-description">
                      <div>
                        Select where you want to display the conversion button.
                      </div>
                      <div>
                        You can also manually add the
                        <strong>[save_as_image_pdfcrowd]</strong>
                        ...
                        or add
                        <strong>create_save_as_image_pdfcrowd_button</strong>
              ...
              data-default="1">
                ...
                <td>
                  <input
                    ...
                    <div class="save-as-image-pdfcrowd-description">
                      Choose whether to show the conversion button in
                      the output the image.
                    </div>
            ...
            <tr class="save-as-image-pdfcrowd-set-group save-as-image-pdfcrowd-adv-input"
              data-default="">
                ...
                <td>
                    ...
                    <div class='save-as-image-pdfcrowd-description'>
                      The ID used for the conversion button in HTML to
                      be used for the custom button styling or
            ...
            <tr class="save-as-image-pdfcrowd-set-group save-as-image-pdfcrowd-adv-input"
              data-default="">
                ...
                <td>
                    ...
                    <div class='save-as-image-pdfcrowd-description'>
                      It is useful together with Button ID for
                      triggering a conversion from your JavaScript.
                    </div>
                    <div class='save-as-image-pdfcrowd-devi'>
            ...
            <tr class="save-as-image-pdfcrowd-set-group"
              data-default="below">
                ...
                <td>
                    ...
                    <div class="save-as-image-pdfcrowd-description">
                      The position of the conversion button relative
                      to the content.
                    </div>
                    <div class='save-as-image-pdfcrowd-devi'>
            ...
            <tr class="save-as-image-pdfcrowd-set-group save-as-image-pdfcrowd-adv-input"
              data-default="center">
                ...
                <td>
                    ...
                    <div class="save-as-image-pdfcrowd-description">
                      The alignment of the conversion button.
                    </div>
                    <div class='save-as-image-pdfcrowd-devi'>
            ...
            <tr class="save-as-image-pdfcrowd-set-group"
              data-default="custom">
                ...
                <td>
                    ...
                    <div class='save-as-image-pdfcrowd-description'>
                      The style can also be changed using the
                      .save-as-image-pdfcrowd-button CSS rule.<br/>
