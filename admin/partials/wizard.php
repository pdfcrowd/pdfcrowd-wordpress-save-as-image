<div id="save-as-image-pdfcrowd-wizard">
    ...
    <div id="save-as-image-pdfcrowd-wizard-step-4" class="save-as-image-pdfcrowd-wizard-step">
        ...
        <div class="save-as-image-pdfcrowd-wizard-step-container">
            ...
            <div id="save-as-image-pdfcrowd-wizard-cm">
                <fieldset>
                    ...
                    <p>
                        <label>
                            <input type="radio"
                                   name="save-as-image-pdfcrowd-wizard-cm"
                                   id="save-as-image-pdfcrowd-wizard-cm-cfg"
                                   value="1">
                            Configure
                            </input>
                        </label>
            ...
            <div id="save-as-image-pdfcrowd-wizard-cm-conf">
                ...
                <p>
                    <input type="checkbox"
       id="save-as-image-pdfcrowd-wizard_cm_public"
       name="save-as-image-pdfcrowd-wizard_cm_public"
       value="1" autocomplete="off">

                    <label for="save-as-image-pdfcrowd-wizard_cm_public">
                        Publicly accessible pages
                    </label>
                </p>
                <p>
                    <input type="checkbox"
       id="save-as-image-pdfcrowd-wizard_cm_pp"
       name="save-as-image-pdfcrowd-wizard_cm_pp"
       value="1" autocomplete="off">

                    <label for="save-as-image-pdfcrowd-wizard_cm_pp">
                        Password protected pages
                    </label>
                </p>
                <p>
                    <input type="checkbox"
       id="save-as-image-pdfcrowd-wizard_cm_data"
       name="save-as-image-pdfcrowd-wizard_cm_data"
       value="1" autocomplete="off">

                    <label for="save-as-image-pdfcrowd-wizard_cm_data">
                        Pages with data entered by users (web forms)
                    </label>
                </p>
                <p>
                    <input type="checkbox"
       id="save-as-image-pdfcrowd-wizard_cm_canvas"
       name="save-as-image-pdfcrowd-wizard_cm_canvas"
       value="1" autocomplete="off">

                    <label for="save-as-image-pdfcrowd-wizard_cm_canvas">
