...
<div id="save-as-image-pdfcrowd-wizard">
    ...
    <h2>
        ...
        <?php esc_html_e( get_admin_page_title() ); ?> Wizard
    </h2>
    <div id="save-as-image-pdfcrowd-wizard-step-1"
         class="save-as-image-pdfcrowd-wizard-step">
        <h2>Conversion Format</h2>
        <div class="save-as-image-pdfcrowd-wizard-step-container">
            <div class="save-as-image-pdfcrowd-wizard-step-row">
    ...
    <div id="save-as-image-pdfcrowd-wizard-step-2"
         class="save-as-image-pdfcrowd-wizard-step">
        <h2>Image Output</h2>
        <div class="save-as-image-pdfcrowd-wizard-step-container">
            <div class="save-as-image-pdfcrowd-wizard-step-row">
    ...
    <div id="save-as-image-pdfcrowd-wizard-step-3"
         class="save-as-image-pdfcrowd-wizard-step">
        <h2>Appearance</h2>
        <div class="save-as-image-pdfcrowd-wizard-step-container">
            <div class="save-as-image-pdfcrowd-wizard-step-row">
    ...
    <div id="save-as-image-pdfcrowd-wizard-step-4"
         class="save-as-image-pdfcrowd-wizard-step">
