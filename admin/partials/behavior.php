    ...
    <table class="form-table">
        <tbody>
            ...
            <tr class="save-as-image-pdfcrowd-email-details">
                ...
                <td>
                    <input type="text" class="regular-text" id="save-as-image-pdfcrowd-email-from" name="save-as-image-pdfcrowd[email_from]" value="<?php echo($email_from);?>" placeholder="<?php esc_attr_e('Sender address', $this->plugin_name);?>" autocomplete="off" />
                    <p class='description'>
            ...
            <tr class="save-as-image-pdfcrowd-email-details">
                ...
                <td>
                    <input type="text" class="regular-text" id="save-as-image-pdfcrowd-email-cc" name="save-as-image-pdfcrowd[email_cc]" value="<?php echo($email_cc);?>" placeholder="<?php esc_attr_e('Carbon copy address', $this->plugin_name);?>" autocomplete="off" />
                    <p class='save-as-image-pdfcrowd-devi'>
            ...
            <tr class="save-as-image-pdfcrowd-email-details">
                ...
                <td>
                    <input type="text" class="regular-text" id="save-as-image-pdfcrowd-email-bcc" name="save-as-image-pdfcrowd[email_bcc]" value="<?php echo($email_bcc);?>" placeholder="<?php esc_attr_e('Blind carbon copy address', $this->plugin_name);?>" autocomplete="off" />
                    <p class='save-as-image-pdfcrowd-devi'>
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="save-as-image-pdfcrowd-edlg-none">
                            <input type="radio" id="save-as-image-pdfcrowd-edlg-none" name="save-as-image-pdfcrowd[email_dialogs]" value="none" <?php checked( $email_dialogs, "none" ); ?> autocomplete="off" />
                            No dialogs
                        </label>
                        <br>
