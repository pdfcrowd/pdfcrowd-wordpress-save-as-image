    ...
    <table class="form-table">
        <tbody>
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="save-as-image-pdfcrowd-button-disp-attachment">
                            <input type="radio" id="save-as-image-pdfcrowd-button-disp-attachment" name="save-as-image-pdfcrowd[button_disposition]" value="attachment" <?php checked( $button_disposition, "attachment" ); ?> />
                            Download the image
                        </label><br>
                        <label for="save-as-image-pdfcrowd-button-disp-inline">
                            <input type="radio" id="save-as-image-pdfcrowd-button-disp-inline" name="save-as-image-pdfcrowd[button_disposition]" value="inline" <?php checked( $button_disposition, "inline" ); ?> />
                            Open the image in the current browser tab
                        </label><br>
                        <label for="save-as-image-pdfcrowd-button-disp-inline_new_tab">
                            <input type="radio" id="save-as-image-pdfcrowd-button-disp-inline_new_tab" name="save-as-image-pdfcrowd[button_disposition]" value="inline_new_tab" <?php checked( $button_disposition, "inline_new_tab" ); ?> />
                            Open the image in a new browser tab
                        </label><br>
                        <label for="save-as-image-pdfcrowd-button-disp-email">
                            <input type="radio" id="save-as-image-pdfcrowd-button-disp-email" name="save-as-image-pdfcrowd[button_disposition]" value="email" <?php checked( $button_disposition, "email" ); ?> />
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="save-as-image-pdfcrowd-er-user">
                            <input type="radio" id="save-as-image-pdfcrowd-er-user" name="save-as-image-pdfcrowd[email_recipient]" value="user" <?php checked( $email_recipient, "user" ); ?> >
                            The address of the logged in user, otherwise prompt for an email address
                        </label>
                        <br>
                        <label for="save-as-image-pdfcrowd-er-prompt">
                            <input type="radio" id="save-as-image-pdfcrowd-er-prompt" name="save-as-image-pdfcrowd[email_recipient]" value="prompt" <?php checked( $email_recipient, "prompt" ); ?> >
                            Prompt for an email address
                        </label>
                        <br>
                        <label for="save-as-image-pdfcrowd-er-address">
                            <input type="radio" id="save-as-image-pdfcrowd-er-address" name="save-as-image-pdfcrowd[email_recipient]" value="address" <?php checked( $email_recipient, "address" ); ?> >
                            Email address
                            <input id="save-as-image-pdfcrowd-er-email-address" type="text" class="regular-text save-as-image-pdfcrowd-text-for-radio" name="save-as-image-pdfcrowd[email_recipient_address]" value="<?php echo($email_recipient_address);?>" placeholder="<?php esc_attr_e('info@example.com', $this->plugin_name);?>">
            ...
            <tr class="save-as-image-pdfcrowd-email-details">
                ...
                <td>
                    <input type="text" class="regular-text" id="save-as-image-pdfcrowd-email-subject" name="save-as-image-pdfcrowd[email_subject]" value="<?php echo($email_subject);?>" placeholder="<?php esc_attr_e('Your subject', $this->plugin_name);?>" />
                    <p class='save-as-image-pdfcrowd-devi'>
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="save-as-image-pdfcrowd-edlg-system">
                            <input type="radio" id="save-as-image-pdfcrowd-edlg-system" name="save-as-image-pdfcrowd[email_dialogs]" value="system" <?php checked( $email_dialogs, "system" ); ?> />
                            System dialogs
                        </label>
                        <br>
                        <label for="save-as-image-pdfcrowd-edlg-modal">
                            <input type="radio" id="save-as-image-pdfcrowd-edlg-modal" name="save-as-image-pdfcrowd[email_dialogs]" value="modal" <?php checked( $email_dialogs, "modal" ); ?> />
                            Predefined modal dialogs
                        </label>
                        <br>
                        <label for="save-as-image-pdfcrowd-edlg-custom">
                            <input type="radio" id="save-as-image-pdfcrowd-edlg-custom" name="save-as-image-pdfcrowd[email_dialogs]" value="custom" <?php checked( $email_dialogs, "custom" ); ?> />
                            Custom dialogs
                            <input type="text" class="regular-text save-as-image-pdfcrowd-text-for-radio" id="save-as-image-pdfcrowd-custom-edlg" name="save-as-image-pdfcrowd[email_custom_dialogs]" value="<?php echo($email_custom_dialogs);?>" placeholder="<?php esc_attr_e('Your JavaScript object name', $this->plugin_name);?>" />
    ...
    prompt: function(converter_callback) {
        ...
        if(email) {
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="save-as-image-pdfcrowd-conversion-mode-auto">
                            <input type="radio" id="save-as-image-pdfcrowd-conversion-mode-auto" name="save-as-image-pdfcrowd[conversion_mode]" value="auto" <?php checked( $conversion_mode, "auto" ); ?> />
                            Auto
                            <p class='description'>
                        ...
                        <label for="save-as-image-pdfcrowd-conversion-mode-url">
                            <input type="radio" id="save-as-image-pdfcrowd-conversion-mode-url" name="save-as-image-pdfcrowd[conversion_mode]" value="url" <?php checked( $conversion_mode, "url" ); ?> />
                            Url
                            <p class='description'>
                        ...
                        <label for="save-as-image-pdfcrowd-conversion-mode-upload">
                            <input type="radio" id="save-as-image-pdfcrowd-conversion-mode-upload" name="save-as-image-pdfcrowd[conversion_mode]" value="upload" <?php checked( $conversion_mode, "upload" ); ?> />
                            Upload
                            <p class='description'>
                        ...
                        <label for="save-as-image-pdfcrowd-conversion-mode-development">
                            <input type="radio" id="save-as-image-pdfcrowd-conversion-mode-development" name="save-as-image-pdfcrowd[conversion_mode]" value="development" <?php checked( $conversion_mode, "development" ); ?> />
                            Development
                            <p class='description'>
                        ...
                        <label for="save-as-image-pdfcrowd-conversion-mode-content">
                            <input type="radio" id="save-as-image-pdfcrowd-conversion-mode-content" name="save-as-image-pdfcrowd[conversion_mode]" value="content" <?php checked( $conversion_mode, "content" ); ?> />
                            Content
                            <p class='description'>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" id="save-as-image-pdfcrowd-auto-use-cookies" name="save-as-image-pdfcrowd[auto_use_cookies]" value="1" <?php checked( $auto_use_cookies, 1 ); ?> />
                    <p class='save-as-image-pdfcrowd-devi'>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="regular-text" id="save-as-image-pdfcrowd-image-created-callback" name="save-as-image-pdfcrowd[image_created_callback]" value="<?php echo($image_created_callback);?>" placeholder="<?php esc_attr_e('Your function name', $this->plugin_name);?>" />
                    <div class='save-as-image-pdfcrowd-m-description'>
                        <p class='save-as-image-pdfcrowd-devi'>
