        ...
        <tbody>
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="save-as-image-pdfcrowd-button-disp-inline">
                            ...
                            open an image in the current browser tab
                        </label><br>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class='save-as-image-pdfcrowd-m-description' style='max-height: none'>
                        <p class='save-as-image-pdfcrowd-devi'>
                            Shortcode & function parameter: "<strong>image_created_callback</strong>"
                        </p>
                        <p class='description'>
                            The callback is invoked when the output image is created. The callback is useful for custom actions, e.g. saving the image to a local folder, setting a custom HTTP response header.
                            <br/>
