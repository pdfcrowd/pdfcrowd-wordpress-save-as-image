...
<div class="wrap">
    ...
    <form method="post" id="save-as-image-pdfcrowd-options" name="save_as_image_pdfcrowd-options" action="options.php">
        ...
        $auto_use_cookies = isset($options['auto_use_cookies']) ? $options['auto_use_cookies'] : '0';
        $button_alignment = isset($options['button_alignment']) ? $options['button_alignment'] : 'center';
        $button_background_color = isset($options['button_background_color']) ? $options['button_background_color'] : '#007bff';
        $button_border_color = isset($options['button_border_color']) ? $options['button_border_color'] : '#007bff';
        $button_border_style = isset($options['button_border_style']) ? $options['button_border_style'] : 'solid';
        $button_border_width = isset($options['button_border_width']) ? $options['button_border_width'] : '1';
        ...
        $button_disposition = isset($options['button_disposition']) ? $options['button_disposition'] : 'attachment';
        $button_format = isset($options['button_format']) ? $options['button_format'] : 'image-text';
        $button_hidden = isset($options['button_hidden']) ? $options['button_hidden'] : '1';
        $button_hover = isset($options['button_hover']) ? $options['button_hover'] : '1';
        $button_html_hidden = isset($options['button_html_hidden']) ? $options['button_html_hidden'] : '0';
        $button_id = isset($options['button_id']) ? $options['button_id'] : '';
        $button_image = isset($options['button_image']) ? $options['button_image'] : 'image1.svg';
        $button_image_height = isset($options['button_image_height']) ? $options['button_image_height'] : '24';
        $button_image_url = isset($options['button_image_url']) ? $options['button_image_url'] : '';
        $button_image_width = isset($options['button_image_width']) ? $options['button_image_width'] : '24';
        $button_indicator = isset($options['button_indicator']) ? $options['button_indicator'] : 'ellipsis';
        $button_indicator_html = isset($options['button_indicator_html']) ? $options['button_indicator_html'] : '<img src="https://storage.googleapis.com/pdfcrowd-cdn/images/spinner.gif"
style="position: absolute; top: calc(50% - 12px); left: calc(50% - 12px);">';
        $button_indicator_timeout = isset($options['button_indicator_timeout']) ? $options['button_indicator_timeout'] : '60';
        $button_margin_bottom = isset($options['button_margin_bottom']) ? $options['button_margin_bottom'] : '6';
        $button_margin_left = isset($options['button_margin_left']) ? $options['button_margin_left'] : '6';
        $button_margin_right = isset($options['button_margin_right']) ? $options['button_margin_right'] : '6';
        $button_margin_top = isset($options['button_margin_top']) ? $options['button_margin_top'] : '6';
        $button_on_categories = isset($options['button_on_categories']) ? $options['button_on_categories'] : '1';
        $button_on_front = isset($options['button_on_front']) ? $options['button_on_front'] : '1';
        $button_on_home = isset($options['button_on_home']) ? $options['button_on_home'] : '1';
        $button_on_pages = isset($options['button_on_pages']) ? $options['button_on_pages'] : '1';
        $button_on_posts = isset($options['button_on_posts']) ? $options['button_on_posts'] : '1';
        $button_on_taxonomies = isset($options['button_on_taxonomies']) ? $options['button_on_taxonomies'] : '1';
        $button_padding_bottom = isset($options['button_padding_bottom']) ? $options['button_padding_bottom'] : '6';
        $button_padding_left = isset($options['button_padding_left']) ? $options['button_padding_left'] : '6';
        $button_padding_right = isset($options['button_padding_right']) ? $options['button_padding_right'] : '6';
        $button_padding_top = isset($options['button_padding_top']) ? $options['button_padding_top'] : '6';
        $button_position = isset($options['button_position']) ? $options['button_position'] : 'below';
        $button_radius = isset($options['button_radius']) ? $options['button_radius'] : '3';
        $button_styling = isset($options['button_styling']) ? $options['button_styling'] : 'custom';
        $button_text = isset($options['button_text']) ? $options['button_text'] : 'Save as Image';
        $button_text_color = isset($options['button_text_color']) ? $options['button_text_color'] : '#fff';
        $button_text_size = isset($options['button_text_size']) ? $options['button_text_size'] : '14';
        $button_text_weight = isset($options['button_text_weight']) ? $options['button_text_weight'] : 'bold';
        ...
        $button_user_drawings = isset($options['button_user_drawings']) ? $options['button_user_drawings'] : '0';
        $conversion_mode = isset($options['conversion_mode']) ? $options['conversion_mode'] : 'url';
        ...
        $dev_mode = isset($options['dev_mode']) ? $options['dev_mode'] : '0';
        ...
        $email_dialogs = isset($options['email_dialogs']) ? $options['email_dialogs'] : 'modal';
        $email_from = isset($options['email_from']) ? $options['email_from'] : '';
        $email_message = isset($options['email_message']) ? $options['email_message'] : '<p>Dear {{user_first_name}} {{user_last_name}},</p>
<p>Please, find {{title}} attached.</p>
<p>Best Regards,<br>
<a href="{{site_url}}">{{site}}</a></p>
        ';
        $email_recipient = isset($options['email_recipient']) ? $options['email_recipient'] : 'user';
        $email_recipient_address = isset($options['email_recipient_address']) ? $options['email_recipient_address'] : '';
        $email_subject = isset($options['email_subject']) ? $options['email_subject'] : '{{site}} - {{title}} Image';
        $image_created_callback = isset($options['image_created_callback']) ? $options['image_created_callback'] : '';
        $license_type = isset($options['license_type']) ? $options['license_type'] : 'demo';
        ...
        $version = isset($options['version']) ? $options['version'] : '2500';
