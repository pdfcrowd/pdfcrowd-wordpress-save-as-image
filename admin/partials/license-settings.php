    ...
    <table class="form-table">
        <tbody>
            <tr>
                ...
                <td>
                    <input type="text" class="regular-text" id="save-as-image-pdfcrowd-username" name="save-as-image-pdfcrowd[username]" value="<?php echo($username);?>" placeholder="<?php esc_attr_e('Your Pdfcrowd username', $this->plugin_name);?>" />
                </td>
            </tr>
            <tr>
                <th scope="row">
