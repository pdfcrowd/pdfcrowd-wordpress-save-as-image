    ...
    <table class="form-table">
        <tbody>
            <tr>
                ...
                <td>
                    <input type="text" class="regular-text" id="save-as-image-pdfcrowd-username" name="save-as-image-pdfcrowd[username]" value="<?php if(!empty($username)) esc_attr_e($username, $this->plugin_name);?>" placeholder="<?php esc_attr_e('Your Pdfcrowd username', $this->plugin_name);?>" />
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    <input type="text" class="regular-text" id="save-as-image-pdfcrowd-api_key" name="save-as-image-pdfcrowd[api_key]" value="<?php if(!empty($api_key)) esc_attr_e($api_key, $this->plugin_name);?>" placeholder="<?php esc_attr_e('Your Pdfcrowd API key', $this->plugin_name);?>" />
                </td>
            </tr>
        </tbody>
    </table>
