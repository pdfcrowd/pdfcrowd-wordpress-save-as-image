...
class Save_As_Image_Pdfcrowd_Public {
    ...
    public function enqueue_styles() {
         ...
         * defined in Save_As_Image_Pdfcrowd_Loader as all of the hooks are defined
         * in that particular class.
         *
         * The Save_As_Image_Pdfcrowd_Loader will then create the relationship
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/save-as-image-pdfcrowd-public.js', array( 'jquery' ), $this->version, false );
    ...
    public function setup_shortcodes() {
        ...
        add_shortcode('string_save_as_image_pdfcrowd',
                      array($this, 'string_save_as_image_pdfcrowd_shortcode'));
    ...
    public static $DEFAULTS = array(
        ...
        'button_image' => 'images/image1.svg',
...
",
    ...
    public static function create_button_from_style(
        ...
        $button = "<div class='$classes'{$div_style}><button class='save-as-image-pdfcrowd-button' type='button'{$btn_style} onclick='window.SaveAsImagePdfcrowd(\"$custom_options\");'>";
    ...
    function string_save_as_image_pdfcrowd_shortcode($attrs = array(), $content = null) {
        // merge attrs with the default options defined on the settings page
        $options = $this->get_options();
    ...
    function save_as_image_pdfcrowd() {
        ...
        $client = new \SaveAsImagePdfcrowd\HtmlToImageClient(
            $options['username'],
            $options['api_key']);
        ...
        try {
            ...
            echo $output;
        } catch(\SaveAsImagePdfcrowd\Error $why) {
